...
#   GP28 : 2026-08-14 DMM 15 점 → +12.0289 ± 0.0585 mA/LSB, 잔차 σ 4.72 mA, 감도 66.99 mV/A
#   GP27 : 2026-08-14 DMM 14 점 → −11.6534 ± 0.0767 mA/LSB, 잔차 σ 3.96 mA, 감도 69.15 mV/A
#   두 채널의 감도가 3.1% 다르다 — ACS37030 부품 공차 범위다.
SCALE_GP28 = 0.9852
SCALE_GP27 = 0.9544

# 부호 : +1 이면 "방전이 양수".
#   GP27 이 −1 인 이유는 **센서 #2 의 IP 단자가 #1 과 반대로 물려 있기 때문**이다.
#   교정 회귀 기울기가 음수로 나왔고(−11.6534), 8/12 로그에도 같은 부호로 남아 있다
#   (id=2 구동 시 GP27 raw 하강 −14.7/−28.6/−45.1).
