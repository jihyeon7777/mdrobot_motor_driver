...
class OrohaPowerNode(Node):
    ...
    def __init__(self):
        ...
        # ✅ **2026-08-28 flash 완료** — 이 경고는 유효기간이 지났다. 옛 펌웨어는
        #   QUIET_GP27 이 음수라 대기분이 상쇄되던 규약에서 V_RAIL_REF 를 잡아 약
        #   +1.0% 를 걸어 왔고, 그동안 총전력이 +1% 높게 나왔다. 08-28 확정 펌웨어를
        #   올린 뒤 rail_corr 이 1.0103 → 1.000 으로 떨어지는 것까지 확인했다
        #   (docs/sensing_constants.md '펌웨어 flash — ✅ 2026-08-28 완료').
