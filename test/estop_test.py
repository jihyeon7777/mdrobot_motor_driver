...
전류 환산: ACS37030LLZATR-020B3 — 1.65 V = 0 A, **66 mV/A** (±20 A 에서 ±1.32 V.
           풀레일이 아니다). 공칭 12.210 mA/LSB, 실제 환산은 아래 #   ⚠ 두 채널 모두 **양(+)** 이다. 08-14 규약의 GP27 음부호(센서 #2 IP 역결선)는 실재했으나
...
LSB_A_CH 의
           2026-08-14 DMM 교정값을 쓴다. 옛 주석의 9.77 mA/LSB 는 ±1.65 V 풀레일을
           가정한 값이라 18.8% 낮다 (보고서 20260814 §7).
