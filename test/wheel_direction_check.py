...
# ACS37030 (66 mV/A). 채널별 실효 A/LSB — 2026-08-14 DMM 교정 (보고서 20260814 §4·§7).
#   GP28 (id=1, 오른쪽) : +12.0289 mA/LSB  (15 점)
#   GP27 (id=2, 왼쪽)   : −11.6534 mA/LSB  (14 점). 음수인 것은 센서 #2 IP 단자 역결선
#                         때문이다. 여기서는 **부호가 판정의 일부**이므로 그대로 둔다.
# ⚠ 08-21 §4: 구동 시 두 채널 raw 가 같은 방향으로 움직였다 — 그 사이 센서 #2 배선이
#   교정된 것으로 보인다(조치 #35). 그러면 GP27 전류가 부호 반대로 나온다. 이 스크립트가
#   그것을 확인하는 자리이므로, 표시된 부호를 **육안 회전 방향과 대조해** 판정할 것.
A_PER_LSB = {"GP28": 12.0289e-3, "GP27": -11.6534e-3}
